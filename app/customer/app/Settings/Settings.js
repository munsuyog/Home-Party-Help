        ...
        <View style={styles.container}>
            <View style={styles.settingsContainer}>
                <View style={styles.settingItem}>
                    <Pressable onPress={() => router.push({ pathname: '/customer/app/Settings/PrivacyPolicy' })}>
                        <Text style={styles.settingText}>Privacy Policy</Text>
                    </Pressable>
                </View>
                <View style={styles.settingItem}>
                    <Pressable onPress={() => router.push({ pathname: '/customer/app/Settings/TermsAndConditions' })}>
